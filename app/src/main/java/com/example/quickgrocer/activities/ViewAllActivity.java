...
public class ViewAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbar_view_all_products);
        ...
        if (type != null && type.equalsIgnoreCase("salt")) {
            firestore.collection("AllProducts").whereEqualTo("type", "salt").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        ////////// Getting DishWash
        if (type != null && type.equalsIgnoreCase("dishwash")) {
            firestore.collection("AllProducts").whereEqualTo("type", "dishwash").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type != null && type.equalsIgnoreCase("rice")) {
            firestore.collection("AllProducts").whereEqualTo("type", "rice").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        ////////// Getting beverage
        if (type != null && type.equalsIgnoreCase("beverage")) {
            firestore.collection("AllProducts").whereEqualTo("type", "beverage").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type != null && type.equalsIgnoreCase("bean")) {
            firestore.collection("AllProducts").whereEqualTo("type", "bean").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
