...
public class MyCartAdapter  extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.totalPrice.setText(String.valueOf(cartModelList.get(position).getTotalPrice())+" Rs");


        holder.deleteItem.setOnClickListener(view -> firebaseFirestore.collection("CurrentUser").document(auth.getCurrentUser().getUid())
