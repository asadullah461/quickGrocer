...
import com.example.quickgrocer.activities.NavCategoryActivity;
...
public class NavCategoryAdapter extends RecyclerView.Adapter<NavCategoryAdapter.ViewHolder> {
    ...
    public NavCategoryAdapter(Context context, List<NavCategoryModel> navCategoryModelList) {
        ...
        this.list = navCategoryModelList;
    }

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.nav_cat_item,parent,
                false));
    }
